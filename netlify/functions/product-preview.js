...
export default async function (request) {
  try {
    ...
    const socialImage = `${process.env.APP_URL || url.origin}/.netlify/functions/product-share-image?${new URLSearchParams({ storeId, productId, v: imageVersion })}`;
